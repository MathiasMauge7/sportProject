...
import { promotion } from "../../infrastructure/data/schema";
...
export type Promotion = InferSelectModel<typeof promotion>
...
export type NewPromotion = InferInsertModel<typeof promotion>
